...
"""x = [1.00, 1.05, 1.10, 1.20, 1.30, 1.40, 1.42, 1.44, 1.46, 1.48, 1.50, 1.60, 1.70, 1.80, 1.90, 2.00, 2.20, 2.40, 2.60, 2.80, 3.00, 3.20, 3.40, 3.60, 3.80, 4.00, 4.50, 5.00, 5.50, 6.00, 7.00, 8.00]
y = []

for i in range(len(x)):
    y.append(potential(3, [0.5,0.1,0.1], x[i], 2.89))
    print([x[i], y[i]])
"""
